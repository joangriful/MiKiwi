...
export default function AddressCard({ address, onSave, onDelete, onSetDefault, isDefault }) {
    ...
    return (
        <div className={`bg-white border rounded-xl p-6 shadow-sm mb-4 relative transition-all ${isDefault ? 'border-[#99b849] ring-1 ring-[#99b849]' : 'border-gray-200 hover:border-gray-300'}`}>
