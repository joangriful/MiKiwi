                ...
                <div className="flex-1 space-y-1">
                    {menuItems.map((item) => (
                        <button
                            ...
                            className={`group flex items-center w-full text-left px-4 py-3 text-sm rounded-lg transition-all duration-200 font-medium ${
                                activeTab === item.id
                        ...
                        >
                            {item.icon && !item.isMaterial && (
                                <span
                                    className={`w-5 h-5 mr-5 flex-shrink-0 transition-colors duration-200 ${
                                        activeTab === item.id
                                            ? "bg-[#99b849]"
                            ...
                            {item.icon && item.isMaterial && (
                                <span
                                    className={`material-symbols-outlined w-5 h-5 mr-5 flex-shrink-0 text-xl leading-none transition-colors duration-200 ${
                                        activeTab === item.id
                                            ? "text-[#99b849]"
