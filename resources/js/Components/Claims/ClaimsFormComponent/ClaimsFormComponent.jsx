...
export default function ClaimsFormComponent() {
    ...
    if (submitted) {
        return (
            <div className={`${styles.root} bg-white rounded-2xl border border-gray-100 shadow-sm p-12 w-full max-w-2xl mx-auto text-center`}>
    ...
    return (
        <div className={`${styles.root} bg-white rounded-2xl border border-gray-100 shadow-sm p-8 md:p-12 w-full max-w-3xl mx-auto`}>
            {/* Header */}
